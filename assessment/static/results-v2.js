...
(function() {
    ...
    var shareUrl = 'https://aiskillsmap.noahratzan.com/assess-v2';
    ...
    var xText = 'My tree: ' + sharePlacement + ' on the Tree-Shaped Designer model. ' +
        'What does yours look like? #DesignInTech';
    ...
    var liText = 'Took the Tree-Shaped Designer assessment from the Design in Tech 2026 framework. ' +
        ...
        'What does yours look like? ' + shareUrl + ' #DesignInTech';
    ...
    var bskyText = 'My tree: ' + sharePlacement + ' on the Tree-Shaped Designer model. ' +
        'What does yours look like? #DesignInTech ' + shareUrl;
    ...
    var copyText = 'I took the Tree-Shaped Designer assessment from the Design in Tech 2026 framework. ' +
        'My tree: ' + sharePlacement + ' \u2014 ' + shareBalance + '. ' +
        'Every combination of root depth and canopy spread gives you a different shape. What does yours look like? ' +
    ...
    function generateMarkdown(r) {
        ...
        md += '---\n*Generated by the [Tree-Shaped Designer Assessment](https://aiskillsmap.noahratzan.com/assess-v2)*\n';
        return md;
    }
